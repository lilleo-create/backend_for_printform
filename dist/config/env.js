...
const otpProvider = rawOtpProvider === 'telegram_gateway' || rawOtpProvider === 'telegram-gateway'
    ? 'telegram'
    : rawOtpProvider;
...
exports.env = {
    ...
    yandexCallbackUrl: process.env.YANDEX_CALLBACK_URL ?? `http://localhost:4000/api/auth/yandex/callback`,

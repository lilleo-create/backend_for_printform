...
exports.isCdekReceiptConfirmed = exports.mapCdekStatusToInternalDeliveryState = exports.parseCdekOrderStatusPayload = void 0;
...
const parseCdekOrderStatusPayload = (payload) => {
...
exports.parseCdekOrderStatusPayload = parseCdekOrderStatusPayload;
const mapCdekStatusToInternalDeliveryState = (statusCode) => {
...
exports.mapCdekStatusToInternalDeliveryState = mapCdekStatusToInternalDeliveryState;
const isCdekReceiptConfirmed = (statusCode) => RECEIPT_CONFIRMED_CODES.has(String(statusCode ?? '').trim().toUpperCase());
exports.isCdekReceiptConfirmed = isCdekReceiptConfirmed;
